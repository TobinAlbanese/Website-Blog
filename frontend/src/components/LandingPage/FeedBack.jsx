            ...
            <div className="col-12">
              ...
              >
                <figure style={{ margin: 0 }}>
                  <img
                    src={`${process.env.NEXT_PUBLIC_SUPABASE_URL}/storage/v1/object/public/public-images/Lucia2.webp`}
                    alt="Photo of family wedding"
                    loading="lazy"
                    onError={(e) => {
                      e.currentTarget.onerror = null;
                      e.currentTarget.src = "/assets/images/Lucia2.webp";
                    }}
                    style={{
                      width: "100%",
                      maxHeight: 600,
              ...
              <div className="row" style={{ marginTop: 40 }}>
                ...
                <div className="col-12 col-md-6">
                  ...
                  >
                    ...
                    {!submitted && error && (
                      <p style={{ marginTop: 15, color: "tomato" }}>{error}</p>
                    )}
