        ...
        >
          <div className="grid">
            <div className="art">
              ...
              >
                {/* === SVG CONTENT (unchanged from your original) === */}
                <g>
                  <defs>
...
278.436,375.599 383.003,264.076 364.393,251.618 264.807,364.928"
            ...
            <div className="copy">
              ...
              <button className="btn black" onClick={() => router.replace("/")}>
                HOME
              </button>
            </div>
          </div>
        ...
        <style jsx>{`
          ...
          /* Make the SVG strokes auto-invert with theme (black on light, white on dark) */
          .art :global(svg) {
            color: var(--nf-fg);
          }
          .art :global(svg [stroke]) {
            stroke: currentColor;
          }
