...
{/*CHANGE THIS*/}
 ...
 <section
    ...
    >
      ...
      >
        {/* Email */}
        <label htmlFor="email" style={{ fontSize: 16, color: "#000000", textAlign: "left", width: "100%", maxWidth: 400 }}>
          Email Address
        </label>
        <input
          type="email"
        ...
        {/* Password */}
        <label htmlFor="password" style={{ fontSize: 16, color: "#000000", textAlign: "left", width: "100%", maxWidth: 400 }}>
          Password
        </label>
        <input
          type="password"
        ...
        <small style={{ marginTop: 10, fontSize: 14, color: "#555" }}>
          Don’t have an account? <a href="/user/SignUp" style={{ color: "#b02621", textDecoration: "underline" }}>Sign up</a>
        </small>
      </form>
    </section>
