        ...
        <div className="base d-flex">
          ...
          <section className="c-bg" data-armstrong-id="wrapper">
              ...
              <div className="col-12">
                ...
                >
                  ...
                  >
                    ...
                    >
                      At Midnight Bureau, you'll find a thoughtful space
                      dedicated to deep dives, critical analyses, and fresh
                      perspectives. From engaging book reviews and carefully
                      curated resources to timely insights on culture and
                      current events, every post is crafted with care by myself,{" "}
                      <em>Tobin Albanese</em>, to inspire, inform, and spark
                      meaningful conversations.
                      <br />
                      Whether you're here to expand your knowledge, discover new
                      ideas, or simply enjoy well-written content, take your
                      time exploring the posts below—there’s something here for
                      every curious mind.
                      <br />
            ...
            >
              ...
              <section id="latest-posts" style={{ marginBottom: 80 }}>
                <h2
                  style={{
                    fontSize: "2.75rem",
                    fontWeight: 800,
