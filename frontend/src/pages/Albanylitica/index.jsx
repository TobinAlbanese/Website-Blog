...
import AlbanyliticaData from '../../data/albanylitica.js';
  ...
  return (
    <Link href={`/Blog/${post.slug}`} passHref>
      ...
      >
        ...
        >
          <h3 style={{ margin: "0 0 12px 0", fontSize: 24, fontWeight: 700 }}>{post.title}</h3>
          <p style={{ margin: 0, fontSize: 16, lineHeight: 1.6 }}>{post.excerpt}</p>
          <small style={{ marginTop: 8, fontSize: 14, color: "#666" }}>
...
export default function Albanylitica() {
            ...
            <div className="menu__section d-flex flex-wrap justify-between gap-y-30 -ml-10 -mr-10 mt-30 mb-80">
              <div className="menu__topics col-12 col-sm-6 col-lg-4-base-10">
                ...
                <ul>
                  ...
                  <li className="menu__topics-list-item mb-10">
                    <a href="/Albanylitica/Archive">Archive</a>
                  </li>
                  <li className="menu__topics-list-item mb-10">
...
<section className="c-bg" style={{ padding: "60px 20px 40px" }}>
        <div className="row base__main" style={{ maxWidth: 1400, margin: "0 auto" }}>
          <div className="row justify-between d-flex">
            ...
            >
              <h1
                ...
                style={{ fontWeight: "900", fontSize: "3rem", marginBottom: 20 }}
              >
                Welcome to Albanylitica
              </h1>
              <p className="body-m" style={{ fontSize: 18, lineHeight: 1.6, color: "#444" }}>
                Dive into thoughtful analyses, book reviews, resources, and current insights curated by Tobin Albanese. 
                Each category brings a unique perspective on politics, culture, and global ideas that shape our world.
                <br /><br />
                Browse through the posts below to explore what interests you most.
              </p>
            </div>
      ...
      <main style={{ maxWidth: "1400px", margin: "40px auto", padding: "0 20px" }}>
        {Object.entries(AlbanyliticaData).map(([category, posts]) => (
          <section key={category} style={{ marginBottom: 60 }}>
            ...
            {/* Matching Portfolio layout here */}
            <div className="posts-container">
              <div className="posts-grid" style={{ display: "flex", flexWrap: "wrap", gap: 24 }}>
                {posts.map((post, idx) => (
                  <div
                    key={post.title}
                    className="post-wrapper"
                    style={{ flex: "0 0 450px", height: "350px", overflow: "hidden" }}
                  >
